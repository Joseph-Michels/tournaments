...
import { CBracket, CMatch, EBracketMatchNameDE6 as MatchName } from "../../data";
...
export class VBracketDE6 extends React.Component<IProps> {
    ...
    public render(): React.ReactNode {
        ...
        const stylesArr: string[] = (this.props.extraStyles !== undefined)
                                        ? [styles.bracketGrid, styles.bracketGridDE6, this.props.extraStyles]
                                        : [styles.bracketGrid, styles.bracketGridDE6];
        return (
            <div className={stylesArr.join(" ")}>
                <div className={`${styles.spanRows18}`} />
                ...
                <div className={`${styles.spanRows4} ${styles.spanCols2}`} />
                <div className={`${styles.spanRows2}`} />
                <div className={`${styles.lineTop} ${styles.spanRows4} ${styles.spanCols2}`} />
                <div className={`${styles.spanRows2}`} />
                <div className={`${styles.lineTop} ${styles.spanRows8} ${styles.spanCols2}`} />
                ...
                <div className={`${styles.spanRows3}`} />
                <div className={`${styles.lineTop} ${styles.spanRows5} ${styles.spanCols2}`} />
                ...
                <div className={`${styles.spanRows4} ${styles.spanCols3}`} />

                <div className={`${styles.spanRows8} ${styles.spanCols2}`} />
                <div className={`${styles.lineTop} ${styles.lineRight} ${styles.spanRows6}`} />
                <div className={`${styles.spanRows2}`} />
                <div className={`${styles.lineBot} ${styles.lineRight} ${styles.spanRows6}`} />
                <div className={`${styles.spanRows2} ${styles.spanCols2}`} />
